    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption">
                  <div  class="banner-body">
                      <h1 class="text-uppercase">Bienvenido a Green Shop</h1>
                       <p  >Los mejores productos y la mejor calidad los encuentras en Green Shop</p>
                 </div>
                </div>
            </div>
            <div class="item">
                ...
                <div class="carousel-caption">
                         <div  class="banner-body">
                      <h1 class="text-uppercase">Los Mejores Productos</h1>
            ...
            <div class="item">
                ...
                <div class="carousel-caption">
                      <div  class="banner-body">
                      <h1 class="text-uppercase">La Mejores Herramientas para tu jardin</h1>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo"> Green Shop </span> en un sencillo formulario para poder completar tus pedidos</p>
